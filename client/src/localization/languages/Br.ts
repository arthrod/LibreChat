...
export default {
  ...
  com_auth_welcome_back: 'Bem-vindo ao Cicero',
  com_auth_back_to_login: 'Voltar para o Login',
  ...
  com_nav_welcome_assistant: 'Bem-vindo ao Cicero',
  com_nav_welcome_message: 'Bem-vindo ao Cicero',
