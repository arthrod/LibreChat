  ...
  return (
    <>
      <h2 className="mb-4 flex gap-2 text-base font-semibold dark:text-gray-200">
        <Layers3 className="icon-lg text-[#FF4040]" />
                    ...
                    return (
                      <Tag
                        ...
                        className={cn(
                          ...
                          tag === 'production' &&
                            'bg-[#FF4040]/10 text-[#FF4040] dark:border-[#FF4040] dark:bg-transparent dark:text-[#FF4040]',
                        )}
                        labelClassName="flex m-0 justify-center gap-1"
                        LabelNode={
                          tag === 'production' ? (
                            <div className="flex items-center ">
                              <span className="slow-pulse h-[0.4rem] w-[0.4rem] rounded-full bg-[#FF4040]" />
                            </div>
                          ) : null
                        }
                      />
