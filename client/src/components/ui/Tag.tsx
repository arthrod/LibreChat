...
const TagPrimitiveRoot = React.forwardRef<HTMLDivElement, TagProps>(
  (
    ...
    <div
      ...
      {...props}
      className={cn(
        'flex max-h-8 items-center overflow-y-hidden rounded-3xl border-2 border-[#FF4040] bg-[#B80000]/20 text-xs text-[#FF4040] dark:text-white',
        className,
      )}
    >
      ...
      {CancelButton
        ...
        : onRemove && (
          <button
            ...
            className="rounded-full bg-[#B80000]/50"
