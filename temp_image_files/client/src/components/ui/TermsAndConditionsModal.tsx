        ...
        buttons={
          <>
            ...
            <button
              ...
              className="inline-flex h-10 items-center justify-center rounded-lg border border-border-heavy bg-surface-secondary px-4 py-2 text-sm text-text-primary hover:bg-[#FF4040] hover:text-white focus:bg-[#FF4040] focus:text-white dark:hover:bg-[#B80000] dark:focus:bg-[#B80000]"
            >
