...
import { AssistantsEndpoint, EModelEndpoint, eModelEndpointSchema } from './schemas';
...
export const endpointSchema = baseEndpointSchema.merge(
  z.object({
    name: z.string().refine((value) => !modularEndpoints.has(value), {
...
export const configSchema = z.object({
  ...
  endpoints: z
    .object({
      ...
      [EModelEndpoint.cicero]: baseEndpointSchema.optional(),
...
export const ciceroModels = [
  'cicero-3-0',
  // Add any other Cicero models here
];

export const defaultModels = {
  [EModelEndpoint.cicero]: ciceroModels,
...
export const EndpointURLs: { [key in EModelEndpoint]: string } = {
  [EModelEndpoint.cicero]: `/api/ask/${EModelEndpoint.cicero}`,
...
export const providerEndpointMap = {
  [EModelEndpoint.cicero]: EModelEndpoint.openAI,
...
// Add this function near other endpoint-related functions
...
// Add this before configSchema
export const ciceroEndpointSchema = baseEndpointSchema.merge(
  z.object({
    apiKey: z.string(),
    models: z.object({
      default: z.array(z.string()).min(1),
...
// Then modify configSchema endpoints object to use ciceroEndpointSchema
export const configSchema = z.object({
  version: z.string(),
  cache: z.boolean().default(true),
  secureImageLinks: z.boolean().optional(),
  ...
  endpoints: z
    .object({
      all: baseEndpointSchema.optional(),
      [EModelEndpoint.cicero]: ciceroEndpointSchema.optional(),
      [EModelEndpoint.openAI]: baseEndpointSchema.optional(),
      [EModelEndpoint.google]: baseEndpointSchema.optional(),
      [EModelEndpoint.anthropic]: baseEndpointSchema.optional(),
      [EModelEndpoint.gptPlugins]: baseEndpointSchema.optional(),
